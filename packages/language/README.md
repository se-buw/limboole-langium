...
- [src/limboole.langium](src/limboole.langium) -  The grammar definition of your language
- [src/limboole-module.ts](src/limboole-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/limboole-validator.ts](src/limboole-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/limboole.monarch.ts](src/syntaxes/limboole.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/limboole.tmLanguage.json](syntaxes/limboole.tmLanguage.json) - Textmate based syntax highlighting instructions.
